...
<script type="text/javascript">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="14%" valign="top"><div style="float:left;clear:none;display:block;width:150px;border:2px dotted;text-align:center;font-size:11px;font-family:Verdana;color:gray;margin-top:25px;">
          <div style="margin:5px 5px 5px 5px;text-align:left;background-color:#EDFBEB;line-height:12pt;"> <img src="../images/transportation.jpg" style="margin:5px auto;margin-left:18px" alt="transportation_services"/>
              <?
	...
	?>        </td>
        <td width="1%">&nbsp;</td>
        <td width="85%" align="center" valign="top"><form action="trans_action.php" method="post" name="form1" id="form1" onsubmit="return validate_form(this); ">
          <table width="100%" border="0" cellspacing="0" cellpadding="0" name="top" id="tab_gray_text">
            <tr>
              ...
              <td height="19" width="100%" align="center" valign="bottom" colspan="2"><span id="tab_red_text">*Important: </span> <span id="tab_bold_text">Prior to submitting any request on this site, you confirm that you have read our TERMS OF SERVICE and accept them.</span><br />
                  <h2 > <br />
                    Transportation Request Form</h2></td>
              <td width="100"><img src="../images/spacer.gif" width="50px" height="1px" /></td>
