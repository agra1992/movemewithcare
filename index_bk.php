...
<div id="last">		
	    ...
	    <p>&nbsp;</p>
	    <p>&nbsp;</p>
	    <table width="100%" ><td width="50%" align="left">
		<? echo nl2br($ret[0][0]); ?>
      <td rowspan="2" colspan="2" valign="top"><p style="margin:0px"></p></td>
    <td width="50%" colspan="2" rowspan="2" align="left" valign="top">
...
"http://www.ibem.biz"><img src="../images/IBEM-banner.gif" height="45px"; border="0"> <span style="margin:300px;"></a> <a href="http://www.coverall.com"><img src="../images/coverall_logo.jpg" height="60px"; border="0"></a></span>
