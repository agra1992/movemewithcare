            ...
            <div class="container home-container">
                ...
                <div class="row">
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <div class="home_text">
                            <!-- TITLE AND DESC -->
                            <h1>Become a member with us!</h1>
                            <p style="color: #F39C13">Terms and Conditions for all movers to abide by</p>

                            <div class="download-btn">
                            <!-- BUTTON -->
                                <a class="tuor btn wow fadeInRight" href="#TERMS">Read Below <i class="fa fa-angle-down" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
    ...
    <section id="TERMS">
          ...
          <div class="container">
            <div class="row">
              ...
              <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>

                <h2><strong>Moving Help Affiliate Agreement</strong></h2>
                <h5>You acknowledge and agree to the following terms and conditions when you use the MoveMeWithCare.com network. Our responsibilities are specific and limited to the terms of this Agreement. You must read, agree with, and accept all of the terms and conditions contained in this Agreement which are those terms, conditions and definitions expressly set out below.</h5><br>
            ...
            <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h5>
                    ...
                    A. The following is a non-exhaustive list of definitions that shall apply to the use of this network; other definitions are included through out the text:<br />
                    ...
                    <strong>*</strong> "Agreement" - the agreement for use of the Moving Help Network.
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>Acknowledgement, Common Sense and Business Judgment</strong></h2>
                  <h5>
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>Other Terms and Conditions</strong></h2>
                  <h5>
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>Referral services</strong></h2>
                  <h5>
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>Labor: You agree that the network is where you offer labor services</strong></h2>
                  <h5>
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>Effective Offer and Acceptance for Services</strong></h2>
                  <h5>
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>Network Fee</strong></h2>
                  <h5>
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>Payment for Services</strong></h2>
                  <h5>
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>Your Obligation to Us</strong></h2>
                  <h5>
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>Certain Prohibited actions regarding the Moving network</strong></h2>
                  <h5>
                    You shall NOT:
                  </h5>
                  <h5>
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>Full Disclosure from Full Service Movers</strong></h2>
                  <h5>    
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>Changes &amp; Cancellations</strong></h2>
                  <h5>
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>Record Keeping/Audit</strong></h2>
                  <h5>
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>Non-Interference</strong></h2>
                  <h5>
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>No Felony Convictions</strong></h2>
                  <h5>
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>Moving member Profile on Full service movers</strong></h2>
                  <h5>
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>Confidentiality/Non-Disclosure</strong></h2>
                  <h5>
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>Protection of Intellectual Property Content</strong></h2>
                  <h5>
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>Trademark and Domain Name Protection</strong></h2>
                  <h5>
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>No Control of Communication or Information and Content</strong></h2>
                  <h5>
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>Your Information on the network</strong></h2>
                  <h5>
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>Copyright Infringement Policy</strong></h2>
                  <h5>
                    ThPursuant to 17 United States Code 512(c)(2) ("Digital Millennium Copyright Act of 1998"), You need to fulfill the requirements specified in Title II of the Digital Millennium Copyright Act of 1998 to file a notice of infringement. The text of this statute can be found at the U.S. Copyright Office web site, <a href="http://lcweb.loc.gov/copyright/" target="_blank">Click here</a>.
                  </h5><br>
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>Release/Waiver of Liability</strong></h2>
                  <h5>
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>Arbitration</strong></h2>
                  <h5>
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>Waiver of Jury Trial/Venue</strong></h2>
                  <h5>
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>Qualification for Use of Our network</strong></h2>
                  <h5>
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>Our relationship with You</strong></h2>
                  <h5>
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>No Third Party Beneficiaries</strong></h2>
                  <h5>
              ...
              <div class="row">
                ...
                <div class='col-md-8 col-md-offset-0 col-xs-10 col-xs-offset-1 wow fadeInRight'>
                  ...
                  <h2><strong>Your Security Practices With Regard to Customer Information</strong></h2>
                  <h5>
          ...
          <div class="container">
            <div class="row">
              <div class="col-xs-12 btn-container">
                <div class="download-btn">
                    <!-- BUTTON -->
                    <a class="btn home-btn wow fadeInLeft" href="http://www.movemewithcare.com/mem2_final_new.php">Agree to the Terms &amp; Conditions <i class="fa fa-check-square-o"></i></a>
                </div>
              </div>
            </div>
          </div>
