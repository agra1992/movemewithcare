...
?>
      <form name="form1" id="form1" method="post" action="" enctype="multipart/form-data">
        <table width="100%" border="0" align="center"  cell-spacing="10" style="font-family:Verdana;font-size:12px">
          <tr>
            <td width="1249" height="314" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="22%" height="298" valign="top"><table width="97%" border="0" cellspacing="0" cellpadding="0">

                  <tr>
                    <td><table width="97%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="265" valign="middle" class="bar_bg">Benefits</td>
                        </tr>
                        <tr>
                          <td height="132" valign="top" class="mem_a_bg" ><table width="97%" border="0" cellpadding="0" cellspacing="0" background="../images/memarea_bg.png" >
                              <tr>
                                <td colspan="3"><img src="../images/memarea_top.png" width="265" height="10" /></td>
                              </tr>
                              <tr>
                                <td width="6%">&nbsp;</td>
                                <td width="89%" align="center"><table width="90%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td><br />
                                        <span style="color:red">&middot;</span></td>
                                    <td align="left"><br />
                                        <span style='color:red'> SMS notification</span></td>
                                  </tr>
                                  <tr>
                                    <td valign="top"><span style="color:red">&middot;</span></td>
                                    <td align="left"><span style="color:red">Deadhaul program: Never come back with empty load</span></td>
                                  </tr>
                                  <tr>
                                    <td valign="top"><span style="color:red">&middot;</span></td>
                                    <td align="left"><span style="color:red">Recommendations to your customers for proper decisions</span></td>
                                  </tr>
                                  <tr>
                                    <td valign="top"><span style="color:red">&middot;</span></td>
                                    <td align="left"><span style="color:red">Marketplace: Free ads available to members</span></td>
                                  </tr>
                                  <tr>
                                    <td valign="top"><span style="color:red">&middot;</span></td>
                                    <td align="left"><span style="color:red">Corporate moving companies: Can dispatch all leads to your agents</span></td>
                                  </tr>
                                </table></td>
                                <td width="5%">&nbsp;</td>
                              </tr>
                ...
                <td width="72%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="4%">&nbsp;</td>
                    <td width="96%" align="center"><strong class="mem_sub_head" >Become a 
        MoveMeWithCare.com member</strong><br /><br /><br /><br />        <br /></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td>What kind of services you want to offer:<br />
                    Please click on corresponding service and scroll down.If you do offer more then one, please re-register for the other services<br /><br /><br /><br /></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td><label for="deadhaul" class="lists"></label></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td><input name="type" type="radio" onclick="setdata()" value="standard" id="standard" />
                      <label for="standard" class="lists">Loading/Unloading Assistance</label>
                      <br />
                      ...
                      <label for="deadhaul" class="lists">Deadhaul</label></td>
                  </tr>
                </table>
                </td>
                <td width="6%" align="center" valign="top"><img src='/images/Deadhaul.gif' alt="" /></td>
              </tr>
            </table>            </td>
          </tr>
        </table>
