...
<script type="text/javascript">
	...
	<div align="left" style="width:600px;height:850px!important;height:2px;padding-left:0px;padding-top:20px!important;padding-left:0px;font-family:Verdana;font-size:12px;color:black;font-size:12px;" >
	<?
	  if ($_SESSION['browser'] != "Mozilla") {
	  	echo "<br>";  
	  }
	?>	
	<form name="form1" method="post" action="trans_action.php" onSubmit="return validate_form(this); ">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" name="top" id="tab_gray_text">
		<tr>
	 		<td align=left valign=top><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td>
                  <table width="1000" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td align="left" valign="top"><span id="tab_red_text">&nbsp;&nbsp;*Important: </span> <span id="tab_bold_text">Prior to submitting any request on this site, you confirm that you have read our TERMS OF SERVICE and accept them.</span></td>
                    </tr>
                  </table></td>
              </tr>
              <tr>
              ...
              <tr>
                <td align="left" valign="top"><table width="75%" border="0" cellspacing="0" cellpadding="6" id="tab_gray_text">
		<tr>
			<td colspan="2" align="center" valign="top"><br /><h2 > Transportation Request Form</h2></td>
			</tr>	
	    <tr> 
	    	<td width="348"><div align="right">Salutation:</div></td>
	      	<td width="605"><select name="salut" id="salut" class="formobject" >
	          	<? 
...
$sel="";	
		...
		<tr>
			<td><div align="right">Estimated Departure Date: <br><!--<i>yyyy-mm-dd</i>--></div></td>
			<td><select name="Day"><? echo ComboList(1,31, $customer_info)?></select>
				
                               <select name="Month"><?   echo ComboList2( $customer_info)?></select>
				
                                <select name="Year"><?  echo ComboList(2008,date("Y")+8, $customer_info)?></select>			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
