...
?>
    ...
    <tr> 
      <td><div align="right">ZipCode/Postal Code (at origin):</div></td>
    ...
    <tr> 
      <td><div align="right">ZipCode/Postal Code (at destination):</div></td>
      <td align="left"><input name="dest_zipcode" type="text" alt="Destination Zip" id="dest_zipcode" size="7" maxlength="7" class="formobject" <?if($autofill) {echo "value='$dest_zipcode'";}else if($customer_info['dest_zipcode']){echo "value=".$customer_info['dest_zipcode']."";}?>></td>
    </tr>
    <tr> 
