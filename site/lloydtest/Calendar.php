...
class Calendar
{
    ...
    */
    ...
    function getMonthHTML($m, $y, $state_id,  $showYear = 1,$member_state, $service_state, $license, $country)
    {
		...
		$str_lupu ="SELECT * FROM tbl_lupu_orders JOIN orders_sent ON orders_sent.order_id= tbl_lupu_orders.OrderID WHERE orders_sent.valid='yes' AND orders_sent.member_id ='".$_SESSION['Member_Id']."' AND 
 tbl_lupu_orders.MoveDate = '$DATE_VAR%'";

				


  	             $str_full = "SELECT * FROM tbl_fs_orders JOIN leads_sent ON leads_sent.lead_id = tbl_fs_orders.OrderID WHERE leads_sent.member_id ='".$_SESSION['Member_Id']."' AND tbl_fs_orders.MoveDate = '$DATE_VAR%'";	
