...
<script type="text/javascript">
	...
	<div align="left" style="width:600px;height:950px!important;height:2px;padding-left:0px;padding-top:20px!important;padding-left:0px;font-family:Verdana;font-size:12px;color:black;font-size:12px;" >
	<?
	...
	<form name="form1" method="post" action="storage_action.php" onSubmit="return validate_form(this);">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" name="top" id="tab_gray_text">
		<tr>
			...
			<td height="19" width="100%" align=center valign=bottom colspan="2">
			  <span id="tab_red_text">*Important: </span>
	          <span id="tab_bold_text">Prior to submitting any request on this site, you confirm that you have read our TERMS OF SERVICE and accept them.</span><br>
			  <h2 >
			  <br>Storage Facility Request Form</h2></td>
			<td width="100"><img src="../images/spacer.gif" width="50px" height="1px" /></td>
...
$sel="";	
		...
		<tr> 
	      	<td><div align="right">Current City:<br /> <i>If your city is not listed, select nearest location</i></div></td>
	      	<td>
	          	<?
...
$sel="";	
		...
		<tr>
			<td><div align="right">Start Date at Storage:<br><!--<i>yyyy-mm-dd</i>--></div></td>
			<td><select name="Day"><?  echo ComboList(1,31, $customer_info,1)?></select>
				<select name="Month"><?  echo ComboList2($customer_info,1)?></select>
				<select name="Year"><?  echo ComboList(2008,date("Y")+8, $customer_info,1)?></select>
			</td>
		</tr>
		<tr>
			<td><div align="right">Finish Date at Storage: <br><!--<i>yyyy-mm-dd</i>--></div></td>
			<td><select name="Day2"><?  echo ComboList(1,31, $customer_info,2)?></select>
					<select name="Month2"><?  echo ComboList2($customer_info,2)?></select>
					<select name="Year2"><?  echo ComboList(2008,date("Y")+8, $customer_info,2)?></select>
			</td>
		</tr>
		<tr>
		   	...
		   	<td><select name="st_size" alt="Storage Size" size="1" id="st_size" style="width:170px; ">
					...
					<option value="6"<? if($customer_info['st_size']==6) echo"selected";?>>Larger than 4 Bedroom</option></select>
			<br><a href="#" onClick="javascript:showsize1();return false;">Confused? We might help you understand your requirement , Click here.</a></td>
	    </tr>
<?php dsp_crypt(0,1); ?>
