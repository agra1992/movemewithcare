...
{	
        if((form1.m_state.value==998 || form1.m_state.value==997) && form1.state.value==999 ){
	form1.distance.disabled = true;}else{
	form1.distance.disabled = false;
        }
}
city = new Array()
states = new Array()
...
?></select></td></tr><tr><td><p>Select the associations you are registered with:</td><td><select name=\"association[]\" id=\"association\" size=\"5\" multiple=\"multiple\" class=\"formobject\" style=\"width: 100%\" ><?php
