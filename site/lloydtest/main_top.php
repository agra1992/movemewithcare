...
{
    truck_window=window.open(image_path, "Truck_Images", "width=300, height=150")
    truck_window.focus();
}
...
<table id="Table_01" width="858" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td colspan="3" rowspan="3"><font color='#F79A30' face='Arial' size='2'><b>This is a &#946;eta version, Thank you for your cooperation<br><span class="style12"><font size=1>If you experience any problems <a href='http://movemewithcare.com/feedback1.php'>click here </a>(if applicable copy and paste the error message you received)</span></font></b></font>
			</td>
