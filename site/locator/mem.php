...
<table>
<tr><td valign="top">
<div id="main_left_side_add" style="align:left;">
...
for($i=30; $i<32; $i++)
{
    ...
    if($add[$i][2] != ""){
        ...
        echo "<a href=javascript:new_add_window('http://".$add[$i][2]."')>http://".$add[$i][2]."</a><br>";
        echo @nl2br($add[$i][0]); 
        echo" </br>";
        if($add[$i][1] != ""){
             echo"<img src='../adds/".$add[$i][1]."' width='100'><br>";
        }
    }
    else{
...
</td><td  background="../images/login_background.jpg" width="500" height="200" valign="top">
...
<td valign="top">
<div id="main_side_add" style="align:left;">
<b id='title'>Sponsored Links</b>
<?
for($i=32; $i<34; $i++)
{
