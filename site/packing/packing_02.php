...
<script type="text/javascript">
	...
	<img src="../images/packing_facilities.gif" style="margin:5px auto;margin-left:18px" alt="storage_facilities"/>
	<?
	...
	<form name="form1" method="post" action="packing_action.php" onSubmit="return validate_form(this);">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" name="top" id="tab_gray_text">
		<tr>
			...
			<td height="19" width="100%" align=center valign=bottom colspan="2">
			  ...
			  <h2 >
			  <br>Packing Materials Request Form</h2></td>
			<td width="100"><img src="../images/spacer.gif" width="50px" height="1px" /></td>
...
$sel="";	
		...
		<tr>
			<td><div align="right">Estimate Date of Moving:<br><!--<i>yyyy-mm-dd</i>--></div></td>
			<td><select name="Day"><?  echo ComboList(1,31, $customer_info)?></select>
				<select name="Month"><?  echo ComboList2($customer_info)?></select>
				<select name="Year"><?  echo ComboList(2008,date("Y")+8,$customer_info)?></select>
			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		...
		<tr>
   			<td><div align="right">Materials Required:<br><i>(Ctrl+Click to select multiple)</i></div></td>
   			<td><select name="materials[]" alt="Materials" size="4" id="materials" style="width:170px; " multiple>
				<option value="1">Boxes</option>
				<option value="2">Tape</option>
            	<option value="3">Moving Equipment</option></select><br></td>
    	</tr>
<?php dsp_crypt(0,1); ?>
