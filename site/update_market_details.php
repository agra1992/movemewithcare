...
function displayCities($StateID, $city_array)
  ...
  $strQuery = "Select tblmembers.pass, tblmembers.Logo,tblmembers.ZipCode, tblmembers.MemberType, tblmembers.sms_service, tblmembers.sms_address, tblmembers.State
                   From tblmembers
 ...
 $strQuery = "Select MemberType
                   From tblmarket
					   Where MID =" . $_SESSION['Member_Id'];
  $result_newQuery = mysql_query($strQuery) or die("Query failed23*3");
  $line = mysql_fetch_array($result_newQuery, MYSQL_ASSOC);
$type=$line[MemberType];
?>
<style type="text/css">
<!--
.button
...
<script LANGUAGE = "Javascript">
 ...
 { 	
	...
	if (MUWCForm.type.value == "")
	{
			errorMsg += "\n\City \t\t\t- Please select your type of service.";
	}	
...
<table border="0" cellspacing="0" cellpadding="5" align="center" >
  ...
  <form action="update_market_details2.php" name="form1" id="form1" method="post">
...
?>
    ...
    ?>
 <tr>
    <td align='right'>Type of Serivce: </td>
    <td>        
