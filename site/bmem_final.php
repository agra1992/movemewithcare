...
<title class="blink">Welcome To MoveMeWithCare</title>
...
<body onLoad="mmLoadMenus();MM_preloadImages('../images/menu.png')">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="1%">&nbsp;</td>
                <td width="74%" align="left" valign="top"><img src="images/slides/slide1.gif" name="slide" width="692" height="250" border="0" id="slide" style="filter:blendTrans(duration=3)" /></a>
...
<script type="text/javascript" src="../old/site/cal.js"></script>
...
<?php if ($name) { ?>
        ...
        <table width="1000" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><table width="1000" border="0" cellpadding="0" cellspacing="0"></td>
              </table>              </td>
                </tr>
          </table>
                </tr>
              ...
              <form name="form1" id="form1" method="post" action="" enctype="multipart/form-data">
                <div align="center">
                  <table width="90%" border="0" align="center"  cell-spacing="10" style="font-family:Verdana;font-size:12px">
                    <tr>
                      <td colspan='2'><p>What kind of services you want to offer:<br />
                        <i>Please click on corresponding service.If you do offer more then one, please re-register for the other services</i></p></td>
                    </tr>
                    <tr>
                      <td  width='400'>What are the benefits? Read below:<br />
                        <span style='color:red'> &middot;SMS notification<br />
                          &middot;Deadhaul program: Never come back with empty load<br />
                          &middot;Recommendations to your customers for proper decisions<br />
                          &middot;Marketplace: Free ads available to members<br />
                          &middot;Corporate moving companies: Can dispatch all leads to your agents<br />
                        </span> </td>
                      <td align="left" ><input name="type" type="radio" onclick="setdata()" value="standard" id="standard" />
                        ...
                        <br />                      </td>
                      <td><img src='/images/Deadhaul.gif' alt="" /> </td>
                    </tr>
                  </table>
                  <br />
                  <style>
#Agreement{
  ...
  text-align:center;
                ...
                <div id="Agreement">
                  <div align="center">
                    <script src="../old/site/scripts/includethis.js">
...
<input type="button" class="button" onclick="window.location='index.php';" value="Disagree"/>-->
          ...
          <tr><td><div align="center"><?echo"$captcha_html";?></div></td></tr>
              <div align="center"><span id="newmember2">
