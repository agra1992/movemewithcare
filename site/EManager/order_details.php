<? 
  // session_start();
   ...
   if($type == "LUPU")
	{
      echo "<h2>Order Details for Order # $OrderID&nbsp; <a href=\"javascript:spWindowOpen($OrderID);\" 
	...
	if($type == "FS")
	{
      echo "<h2>Order Details for Order # $OrderID&nbsp; <a href=\"javascript:spWindowOpen1($OrderID);\" 
            title=\"Click here to print this page\">
		 <img src=\"graphics/print.gif\" border=\"0\"></a></h3> 
          <br><br>";
	}
...
<script language="JavaScript">
  ...
  function spWindowOpen(OrderID)
  {  
	SpdWindowOpen=window.open('print_page.php?PageType=LUPUOD&ID='+OrderID,'newwSp','status=yes,scrollbars=yes,width=600,height=600,left=10,top=20')
  }
  
  var SpdWindowOpen1;
  
  function spWindowOpen1(OrderID)
  {  
	SpdWindowOpen1=window.open('print_page.php?PageType=FSOD&ID='+OrderID,'newwSp','status=yes,scrollbars=yes,width=600,height=600,left=10,top=20')
  }
