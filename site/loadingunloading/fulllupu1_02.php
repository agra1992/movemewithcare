...
if($same_country==1){
    if($serv1==1){
            if($transport=="yes"){
                $message="&bull;  Are you interested in more than Loading /Unloading services? Then please visit our Full Service Local Distance movers . They can provide you with loading,packing,transport,unloading, unpacking and warehousing. Please go <a href='http://movemewithcare.com/locator/fullservicemovers.php'>here</a><br>
...
";
            ...
            if($transport=="yes"){
                ...
                $message="&bull;  Are you interested in more than Loading /Unloading services? Then please visit our Full Service Long distance movers . They can provide you with loading,packing,transport,unloading, unpacking and warehousing. Please go <a href='http://movemewithcare.com/locator/fullservicemovers.php'>here </a><br>
&bull;  Since you do need transportation, our state of the art system sent an email to all the transportation providers that can provide you with dependable transportation. Either looking for ULoad/They drive or rent and drive, we can help you.<br>
&bull;	We also recommend you to visit our Packing supplies TAB to get discounted prices on our packing supplies to adequately protect your furniture in transit and also if you do decide to store your furniture in a safe place, our Storage Facilities have state of the art security system at your convenience<br>
";
            }
...
";
    ...
    if($transport=="yes"){
        $message="&bull;  Are you interested in more than Loading /Unloading services? Then please visit our Full Service International Long Distance movers . They can provide you with loading,packing,transport(across borders),unloading, unpacking and warehousing. Please go <a href='http://movemewithcare.com/locator/fullservicemovers.php'>here</a> <br>
&bull;  Since you do need transportation, our state of the art system sent an email to all the transportation providers that can provide you with dependable transportation. Either looking for ULoad/They drive, or rent and drive, we can help you. <br>
&bull;  We also recommend you to visit our Packing supplies TAB to get discounted prices on our packing supplies to adequately protect your furniture in transit and also if you do decide to store your furniture in a safe place, our Storage Facilities have state of the art security system at your convenience. <br>
";
    }
...
?>
      ...
      <tr>
        <td><? include_once "../bottom_panel_02.php"; ?></td>
      </tr>
    </table></td>
  </tr>
