...
<table width="1000" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="257" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="11%">&nbsp;</td>
        <td width="89%" valign="top"><div align="justify"><img src="../images/loadingunloading.gif" style="margin:5px auto;margin-left:18px" alt="fullservice_movers"/> <? echo @nl2br($line[Detail]); ?> </div></td>
      </tr>
    </table></td>
    <td width="10" align="center" valign="top">&nbsp;</td>
    <td width="737" align="center" valign="top"><form name="loadin" action="fulllupu.php" method="post">
...
<tr> 
	<td colspan="2" align="left" style="text-align:center"><div align="center" ><h2>Welcome to Moving help wizard</h2></div>
	  <div align="justify"><br />
	    <span id="tab_bold_text">With our moving help wizard, posting a moving job should be as easy as 1-2-3. Yes, that's it - in just three easy steps, you'll locate your accredited moving company to serve you. Actually, it is the moving company that will find YOU. No more stress when it comes to MOVING. Our network will make your moving experience as fun and easy as possible. </span>
	    <br />
	        <br />
	    </div>
...
<div style="position:relative; bottom:50px;">
<![endif]-->
<? include_once "../bottom_panel_02.php"; ?>