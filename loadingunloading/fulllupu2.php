...
With just few minutes of your time, we'll help you make your relocation request a successful and enjoyable one! -->              </td>
          </tr>
          <tr>
            <td align="center" valign="top"><div align="justify" style="padding:5px;"><? echo nl2br($line[Detail]); ?></div></td>
          </tr>
        </table></td>
        <td width="845" align="left" valign="top"><form action="fulllupu_action.php" method="post" name="form1" onsubmit="return validate_form(this);">
 <table width="845" border="0" cellspacing="0" cellpadding="0" name="top">
				<tr>
	...
	?>
				...
				<tr>
				  <td height="19" align=left valign=top><table width="95%" border="0" cellspacing="0" cellpadding="4" >
                    <tr>
                      <td><a name="top"></td>
                    </tr>
                    <tr>
...
if($customer_info['salut'] != "")
		  ...
		  echo "<option value=$salut selected> $salut </option>";
                    ...
                    <!-- start by Tj -->
                    <tr>
                      <td colspan='2'><span id="tab_bold_text"> </span>
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td align="center" valign="middle"><span id="tab_bold_text"> If not correct city or state/province: 
                              Please go back to step ONE by clicking on <a href="javascript:history.go(-3)"
                                style='font:10pt arial bold'> here </a>.</span></td>
                            </tr>
                        </table></td>
                    </tr>
                    <!-- end -->
                    <tr>
                      <td><div align="right">
                        Current State/Province:</td>
                      <td align="left"><span id="tab_bold_text">
...
?>
	...
	<tr><td><div align="right">Type of Move:<br>
	  ...
	  <input type="radio" value="1" name="serv1" id="serv2" alt="Type Of Move" <?=$sel2?>><label for="serv2">Long Distance</label>
                    ...
                    <tr>
                      <td align="left"><div align="right">Destination State/Province :<br />
                      </div></td>
                      <td align="left"><?
		...
		*/
		...
		?>
                          <input type="text" name="txt_destinationstate" id="txt_destinationstate" value="<?php echo $line['name']; ?>" disabled="disabled" />
                        </input>
                          <br />                      </td>
                    </tr>
                    <tr>
                      <td align="left"><div align="right"> Destination City :<br />
                      </div></td>
                      <td align="left"><?		
		...
		*/
		...
		?>
                          <input type="text" name="txt_destinationcity" id="txt_destinationcity" value="<?php echo $line['city']; ?>" disabled="disabled" />
                        </input>
                          <br />                      </td>
                    </tr>
...
<a href="javascript:show_calendar('form1.st_date');" onMouseOver="window.status='Date Picker'; overlib('Click here to choose a date from pop-up calendar.'); return true;" onMouseOut="window.status=''; nd(); return true;">Pick from calendar</a> -->                      </td>
                    </tr>
                    <tr>
                      <td><div align="right"> Quantity of labors you need:</div></td>
                      <td align="left"><select name="labors" id="labors" class="formobject" onchange="switchlabors(this.value)">
                          ...
                          <span id="total"> x 3 hours = $340*</span> &nbsp;&nbsp; <span id="MUWC"> Including MUWC Deposit: $80</span> </td>
                    </tr>
				    <tr>
                      <td>&nbsp;</td>
				      <td><div align="justify"><sup>*</sup>Includes 3 hours labor plus the one hour travel time. Additional hours after the three is <span id='additional'>$80 / hour </span><br />
                              <br />
                              ...
                              <br />
				        Packing, Loading/Unloading, unpacking are considered one type of service if provided by one moving agent within the same state. Only ONE deposit is required in this case.</div></td>
				      </tr>
                    <tr>
                      <td><div align="right"> Last 4 digits of your credit card number:<br />
                        You won`t be directly charged.<br />
                        <a href="#" onclick="javascript:showpolicy();return false;">
                          <!--Credit Card Privacy Terms-->
                          Why we ask that?</a></div></td>
                      <td align="left"><input name="credit" type="password" id="credit" size="14" maxlength="4" class="formobject" />
                          <br />
                    ...
                    <tr align="center">
                      <td colspan="2"><input type="submit" name="Submit" value="Request a Loading/UnLoading Service Provider" id="next" style="width: 320px; font-size: x-small; font-family: Arial; color: #; background-color: #dceffe; border: 1 outset #;margin-right:50px;" /></td>
                      </tr>
                    <tr>
