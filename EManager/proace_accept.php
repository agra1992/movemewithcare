...
$location = $_GET['location'];
 $resend_last_message="Pro ace has accepted the order ($OrderID) at ($location)";
$sql = "Update tbl_lupu_orders SET ".$location."_MID='73' , Status_$location ='A' WHERE OrderID='$OrderID'";
$r =mysql_query($sql);
...
function admin_message_origin($customerName, $customerPhone, $customerPhone2, $customerZipCode, $movingDate, $labors, $or_info, $memberName, $memberState, $memberContactPerson, $memberEmail,$memberPhone)
{
    $message="";
	...
	$result = mysql_query($sql) or die("Query failed23");
		...
		$message  = str_replace ("%JobInfo%", "LUPU", $temp_message);
...
function admin_message_destination($customerName, $customerPhone, $customerPhone2, $customerZipCode, $movingDate, $labors, $dest_info, $memberName, $memberState, $memberContactPerson, $memberEmail,$memberPhone)
{
$message="";
...
function admin_message_both($customerName, $customerPhone, $customerPhone2, $customerZipCode, $movingDate, $labors, $or_info, $dest_info, $memberName, $memberState, $memberContactPerson, $memberEmail,$memberPhone)
{
    $message="";
...
{    	//mail to admin
    ...
    if($both==false){
         $message=admin_message_origin($customerName, $customerPhone, $customerPhone2, $customerZipCode, $movingDate, $labors, $or_info, $memberName, $memberState, $memberContactPerson, $memberEmail,$memberPhone);
		$Subject = "A Provider has accepted service request at origin";
    }
    else{
         $message=admin_message_both($customerName, $customerPhone, $customerPhone2, $customerZipCode, $movingDate, $labors, $or_info, $dest_info, $memberName, $memberState, $memberContactPerson, $memberEmail,$memberPhone);
...
//mail admin
    if($both==false){
         $message=admin_message_destination($customerName, $customerPhone, $customerPhone2, $customerZipCode, $movingDate, $labors, $dest_info, $memberName, $memberState, $memberContactPerson, $memberEmail,$memberPhone);
