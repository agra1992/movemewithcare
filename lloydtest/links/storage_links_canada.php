...
$count=0;
$sql_total = "SELECT count(*)  FROM links WHERE Country='canada' AND Type='storage' AND Active='1'";
$r = mysql_query($sql_total);
$total = mysql_fetch_array($r);

$sql="SELECT `URL`, `Image` FROM links WHERE Country='canada' AND Type='storage' AND Active='1'";
$r=mysql_query($sql);
$count=0;
...
{
   $output = $i+1;
   echo"   <a href=/links/storage_links_canada.php?page=$i>$output</a>";
}
