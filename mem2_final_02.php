...
<form name="form1" id="form1" method="post" action="" enctype="multipart/form-data">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="27%" align="right" valign="top"><table width="58%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="283" valign="middle" class="bar_bg">Benefits</td>
                </tr>
                <tr>
                  <td height="132" valign="top" class="mem_a_bg" ><table width="100%" border="0" cellpadding="0" cellspacing="0" background="../images/memarea_bg.png" >
                      ...
                      <tr>
                        <td width="6%" align="center" valign="top"><strong>-</strong><br />
                        <strong>-</strong><br /><br /><strong>-</strong><br /><br /><strong>-</strong><br /><br /><strong>-</strong></td>
                        <td width="89%" align="left" ><span style='color:red'> SMS notification<br />
                          ...
                          Corporate moving companies: Can dispatch all leads to your agents<br />
                        </span></td>
                        <td width="5%">&nbsp;</td>
                      </tr>
                  </table></td>
      ...
      <td width="1%">&nbsp;</td>
      <td width="69%" align="left" valign="top" class="txtbody"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="left"> <p align="center"><strong><font face="Arial, Helvetica, sans-serif" size="5">Become a 
    MoveMeWithCare.com member</font></strong></p></td>
            </tr>
            <tr>
              <td align="left">What kind of services you want to offer:<br />
                <i>Please click on corresponding service.If you do offer more then one, please re-register for the other services</i></td>
          </tr>
            <tr>
             <td width="69%" align="left" valign="top" class="txtbody"><input name="type" type="radio" onclick="setdata()" value="standard" id="standard2" />
          <label for="standard2" class="lists">Loading/Unloading Assistance</label>
          <br />
          <input type="radio" name="type" value="full" onclick="setdata()" id="full2" />
          <label for="full2" class="lists">Full service (Includes Packing, Loading, Transportation, Unloading, Unpacking and Warehousing)</label>
          <!--(<strong><s>$250</s> $100/month special price</strong>)-->
          <br />
          <input type="radio" name="type" value="transport" onclick="setdata()" id="transport2" />
          <label for="transport2" class="lists">Transportation Services (Includes Local truck rental, long distance truck rental, truck with drivers,<br />
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;portable storage system)</label>
          <br />
          <input type="radio" name="type" value="storage" onclick="setdata()" id="storage2" />
          <label for="storage2" class="lists">Storage Facility (Provide storage locally and nationally, corporate storage facility providers, franchises, etc..)</label>
          <br />
          <input type="radio" name="type" value="packing" onclick="setdata()" id="packing2" />
          <label for="packing2" class="lists">Packing Supplies (All packing supplies providers able to ship locally and nationwide)</label>
          <br />
          <input type="radio" name="type" value="market" onclick="setdata()" id="market2" />
          <label for="market2" class="lists">Marketplace (A variety of services)</label>
          <br />
          <input type="radio" name="type" value="deadhaul" onclick="setdata()" id="deadhaul2" />
          <label for="deadhaul2" class="lists">Deadhaul</label>
          <br /></td>
            </tr>
          </table>
      <br /></td>
      <td width="3%"><img src='/images/Deadhaul.gif' /></td>
    </tr>
  </table>
  <br>
<style>
