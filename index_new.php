...
<head>
    ...
    <title>Moving people &amp; companies nationwide international|Loading/unloading moving|Full service Movers|Car shipping</title>
    <!-- Google Font -->
                ...
                <div class="row">
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        <div class="home_text">
                            ...
                            <p style="color: #F39C13">Want to move? Look no further!</p>

                            <div class="download-btn">
                            <!-- BUTTON -->
                                <a class="tuor btn wow fadeInRight" href="#ABOUT">Take a tour <i class="fa fa-angle-down" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
