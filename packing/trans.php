...
<li><p>We see that you chose Loading and Unloading services, we recommend you to go to <a href="../loadingunloading/loadingunloading.php">Loading/unloading tab </a>to request for a loading or unloading moving service provider.Please <a href="../loadingunloading/loadingunloading.php">go here</a></p></li>
<?} else if($showrec=="full") {?>
<li><p>Are you interested in more than just Loading/Unloading moving help? Then please visit our <a href="../locator/fullservicemovers.php"> Full  <?=$serv1_state?> Service Accredited Movers </a>than can provide you with packing services, loading, transport and unloading. Please <a href="../locator/fullservicemovers.php">go here </a></p></li>
<?} else {?>
<li><p>If you do prefer to Do-It-Yourself option, we recommend you using our <a href="../loadingunloading/loadingunloading.php">Loading/Unloading services </a> and also contact our transporation providers to rent a local truck or hire for driver option in case of long distance move. For transportation services, please visit Transportation Help tab.</p></li>
<?}?>
